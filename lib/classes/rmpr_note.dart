...
class RmprNote extends HiveObject {
	...
	RmprNote({required this.name, required this.note, required this.toDoItems, required this.tags});
...
RmprNote defToDoNote = RmprNote(
	name: "Default",
	note: "Default Note",
	toDoItems: [defToDoP.clone(), defToDoN.clone(), defToDoC.clone()],
...
RmprNote getAllToDos() {
	...
	return RmprNote(name: keyAll, note: "All Items", toDoItems: toDoList, tags: {});
} // end getAllToDos
...
RmprNote newRmprNote(String name) {
  ...
  currentFile.notes[name] = RmprNote(name: name, note: "", toDoItems: [], tags: {});
